...
testFn()
	...
	namespace CheatVariables 
	{
		...
		std::vector<Unity::CGameObject*> Ghosts(NULL);
		std::vector<Unity::CGameObject*> CursedItems(NULL);
	...
	namespace CheatMenuVariables {
		...
		bool ItemsSnapline = false;
		bool RainbowItemsSnapline = false;
		ImColor ItemsSnaplineColor = ImColor(255.0f / 255, 255.0f / 255, 255.0f / 255);
		...
		bool ItemsBox = false;
		bool RainbowItemsBox = false;
		ImColor ItemsBoxColor = ImColor(255.0f / 255, 255.0f / 255, 255.0f / 255);
